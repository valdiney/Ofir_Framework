...
{   
	...
	*/
	public static function in_post($input_value = false)
	{
	...
	*/
	public static function in_get($input_value = false)
	{
	...
	*/
	public static function in_files($input_name = false, $file_name = false)
	{
		if ($file_name) {
